...
function Chat() {
  ...
  const [currentChatIndex] = useState(0);
  ...
  const handleSendImage = () => {
    ...
    setTimeout(() => {
      const botResponses = [
        "Thanks for your image! Our team will analyze it and respond shortly.",
        "We've received your crop photo. Our agricultural experts are reviewing it now.",
        "Your image has been logged. We'll get back to you with expert advice soon.",
      ];
            ...
            {chats[currentChatIndex].length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center p-8">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md">
                  Send a photo of your crop issue for a more accurate diagnosis.
                </p>
              </div>
            ) : (
          ...
          <div className="p-4 border-t border-green-100 dark:border-green-900/50 bg-green-50/60 dark:bg-gray-700/20 rounded-b-2xl">
            ...
            <div className="flex gap-2 items-center justify-center">
              ...
              <button
                ...
                disabled={!image}
                className="bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white px-6 py-2 rounded-lg font-medium shadow-md transition-all focus:outline-none focus:ring-2 focus:ring-green-400"
